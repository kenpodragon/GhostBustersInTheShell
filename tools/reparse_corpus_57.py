#!/usr/bin/env python3
"""Re-parse Stephen's corpus with 57-element voice profile (includes spaCy elements).

Usage: python tools/reparse_corpus_57.py
...
EXPORT_PATH = Path(__file__).resolve().parent.parent.parent / "docs" / "voice_profiles" / "stephen_voice_baseline_export_03282026_57.json"
MIN_WORDS = 500

SPACY_ELEMENTS = [
    "adjective_to_noun_ratio",
    "adverb_density",
    "verb_tense_past_ratio",
...
def main():
    ...
    # 5. Print spaCy element values
    print("\n--- spaCy Element Values ---")
    for el in elements:
        if el["name"] in SPACY_ELEMENTS:
