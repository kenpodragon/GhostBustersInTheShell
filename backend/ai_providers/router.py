...
def route_analysis(text: str, use_ai: bool = None, use_lm_signals: bool = False) -> dict:
    ...
    if ai_score is not None:
        ...
        result = {
            ...
            "paragraphs": heuristic_result.get("paragraphs", []),
            "document_patterns": heuristic_result.get("document_patterns", []),
            "detected_patterns": heuristic_result.get("detected_patterns", []),
            "confidence": heuristic_result.get("confidence", (0, 0)),
            "genre": heuristic_result.get("genre", "general"),
            "signal_count": heuristic_result.get("signal_count", 0),
